...
/**
 * JNDI {@link ObjectFactory} for storing and serving LDAP connections. The
 * connection factory creates a {@link DirContext} with the environment set as
 * the properties of the JNDI reference in the application server. Since the
 * connection factory is for LDAP connections the LDAP properties specified in
 * {@link Context}. The property name should be the constants encaptulated by
 * the static properties exposed by {@link Context}. For example, instead of
 ...
 * <ol>
 * <li>
 * Copy the library jar file (<code>i2m-jndi.jar</code>) to the application
 * server library directory (e.g. <code>${glassfish.home}/lib</code>) and
...
public class LdapConnectionFactory implements ObjectFactory {
    ...
    private static final Logger LOG = Logger.getLogger(LdapConnectionFactory.class.
            getName());
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        while (references.hasMoreElements()) {
            ...
            LOG.log(Level.CONFIG, "Property [{0}] = [{1}]", new Object[]{addr.getType(), addr.getContent()});
        }
